function L_Change() {
    ...
    if (language = "jp") {
        location.href = "../jp/cohens_d_jp.html"
    }
}
function GetResults() {
    ...
    if (TotalN >= 50) {
        ...
        CohenD = CohenD.toFixed(2);
        document.getElementById("results_bun").style.display="block";
        document.getElementById("results_bun").innerHTML = "Your <i>N</i> values were small and needed a corrected calculation of Cohen's D. For your data set, <i>d</i> = " + CohenD;
    }
