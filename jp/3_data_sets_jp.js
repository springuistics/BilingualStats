...
function KW(k, deets, data1, data2, data3, data4, data5, data6) {
    ...
    if (p > 0.05) {
        ...
        if (k==3) {
            result3 = "）ので、事後解析としてダン検定でグループ間の差を計算しました。その結果： <br>Group 1 x Group 2: <i>p</i> = " + dunn1v2 + "<br>Group 1 x Group 3: <i>p</i> = " + dunn1v3 + "<br>Group 2 x Group 3: <i>p</i> = " + dunn2v3;
        } else if (k==4) {
            result3 = "）ので、事後解析としてダン検定でグループ間の差を計算しました。その結果： <br>Group 1 x Group 2: <i>p</i> = " + dunn1v2 + "<br>Group 1 x Group 3: <i>p</i> = " + dunn1v3 + "<br>Group 1 x Group 4: <i>p</i> = " + dunn1v4 + "<br>Group 2 x Group 3: <i>p</i> = " + dunn2v3 + "<br>Group 2 x Group 4: <i>p</i> = " + dunn2v4 + "<br>Group 3 x Group 4: <i>p</i> = " + dunn3v4;
        } else if (k==5) {
